  ...
  return (
    ...
    <div className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="w-full h-full bg-[url('/images/audi1.jpg')] bg-cover bg-center grayscale opacity-30 scale-105" />
      </div>
      ...
      <div className="relative z-20 text-center px-4 max-w-5xl">
        ...
        >
          ...
          <p className="text-xl md:text-2xl font-bold text-gray-400 mb-10 max-w-2xl mx-auto uppercase tracking-wide">
            Driving the LKQ Euro Car Parts, Edinburgh's Premier Driver Training <span className="text-white">Audi S3 Saloon</span> for Power Maxed Racing.
          </p>
